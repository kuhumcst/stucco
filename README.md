...
The `recap` project is an ongoing effort to build a collection of lightly [skeuomorphic](https://en.wikipedia.org/wiki/Skeuomorph),  reusable [reagent](https://github.com/reagent-project/reagent) components for building a UI of discrete parts connected by shared state.
